...
export declare type ChangedMasterCopyEvent = TypedEvent<[
    string
], {
    masterCopy: string;
}>;
export declare type ChangedMasterCopyEventFilter = TypedEventFilter<ChangedMasterCopyEvent>;
...
export interface GnosisSafe extends BaseContract {
    ...
    functions: {
        ...
        changeMasterCopy(_masterCopy: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        execTransaction(to: string, value: BigNumberish, data: BytesLike, operation: BigNumberish, safeTxGas: BigNumberish, baseGas: BigNumberish, gasPrice: BigNumberish, gasToken: string, refundReceiver: string, signatures: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        signMessage(_data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        isValidSignature(_data: BytesLike, _signature: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
