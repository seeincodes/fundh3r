...
export interface ProxyFactoryInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "calculateCreateProxyWithNonceAddress", values: [string, BytesLike, BigNumberish]): string;
    encodeFunctionData(functionFragment: "createProxy", values: [string, BytesLike]): string;
    encodeFunctionData(functionFragment: "createProxyWithCallback", values: [string, BytesLike, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "createProxyWithNonce", values: [string, BytesLike, BigNumberish]): string;
...
export declare type ProxyCreationEvent = TypedEvent<[
    string,
    string
], {
    proxy: string;
...
export declare type ProxyCreationEventFilter = TypedEventFilter<ProxyCreationEvent>;
export interface ProxyFactory extends BaseContract {
    ...
    functions: {
        calculateCreateProxyWithNonceAddress(_singleton: string, initializer: BytesLike, saltNonce: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createProxy(singleton: string, data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createProxyWithCallback(_singleton: string, initializer: BytesLike, saltNonce: BigNumberish, callback: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        createProxyWithNonce(_singleton: string, initializer: BytesLike, saltNonce: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    proxyRuntimeCode(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        calculateCreateProxyWithNonceAddress(_singleton: string, initializer: BytesLike, saltNonce: BigNumberish, overrides?: CallOverrides): Promise<string>;
        createProxy(singleton: string, data: BytesLike, overrides?: CallOverrides): Promise<string>;
        createProxyWithCallback(_singleton: string, initializer: BytesLike, saltNonce: BigNumberish, callback: string, overrides?: CallOverrides): Promise<string>;
        createProxyWithNonce(_singleton: string, initializer: BytesLike, saltNonce: BigNumberish, overrides?: CallOverrides): Promise<string>;
        proxyCreationCode(overrides?: CallOverrides): Promise<string>;
        proxyRuntimeCode(overrides?: CallOverrides): Promise<string>;
    };
    filters: {
        "ProxyCreation(address,address)"(proxy?: null, singleton?: null): ProxyCreationEventFilter;
