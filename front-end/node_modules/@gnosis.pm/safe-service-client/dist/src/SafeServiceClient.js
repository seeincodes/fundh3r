...
var _SafeServiceClient_txServiceBaseUrl, _SafeServiceClient_ethAdapter;
...
class SafeServiceClient {
    constructor({ txServiceUrl, ethAdapter }) {
        ...
        _SafeServiceClient_ethAdapter.set(this, void 0);
        __classPrivateFieldSet(this, _SafeServiceClient_txServiceBaseUrl, (0, utils_1.getTxServiceBaseUrl)(txServiceUrl), "f");
        __classPrivateFieldSet(this, _SafeServiceClient_ethAdapter, ethAdapter, "f");
    }
    /**
    ...
    async getSafesByOwner(ownerAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(ownerAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/owners/${address}/safes/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getSafeInfo(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getSafeDelegates(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/delegates/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async addSafeDelegate({ safe, delegate, label, signer }) {
        ...
        const { address: safeAddress } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safe);
        const { address: delegateAddress } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(delegate);
    ...
    async removeSafeDelegate({ safe, delegate, signer }) {
        ...
        const signature = await signer.signMessage(data);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${safeAddress}/delegates/${delegateAddress}`,
            method: httpRequests_1.HttpMethod.Delete,
            body: {
                safe: safeAddress,
                delegate: delegateAddress,
    ...
    async getSafeCreationInfo(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/creation/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async estimateSafeTransaction(safeAddress, safeTransaction) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/multisig-transactions/estimations/`,
            method: httpRequests_1.HttpMethod.Post,
    ...
    async proposeTransaction({ safeAddress, senderAddress, safeTransaction, safeTxHash, origin }) {
        ...
        const { address: safe } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        const { address: sender } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(senderAddress);
        if (safeTxHash === '') {
            throw new Error('Invalid safeTxHash');
        }
        return (0, httpRequests_1.sendRequest)({
    ...
    async getIncomingTransactions(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/incoming-transfers/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getModuleTransactions(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/module-transactions/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getMultisigTransactions(safeAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/multisig-transactions/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getPendingTransactions(safeAddress, currentNonce) {
        ...
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/multisig-transactions/?executed=false&nonce__gte=${nonce}`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
    /**
    ...
    async getAllTransactions(safeAddress, options) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        const url = new URL(`${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/all-transactions/`);
    ...
    async getBalances(safeAddress, options) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        let url = new URL(`${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/balances/`);
    ...
    async getUsdBalances(safeAddress, options) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        let url = new URL(`${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/balances/usd/`);
        const excludeSpam = ((_a = options === null || options === void 0 ? void 0 : options.excludeSpamTokens) === null || _a === void 0 ? void 0 : _a.toString()) || 'true';
        url.searchParams.set('exclude_spam', excludeSpam);
        return (0, httpRequests_1.sendRequest)({ url: url.toString(), method: httpRequests_1.HttpMethod.Get });
    }
    ...
    async getCollectibles(safeAddress, options) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(safeAddress);
        let url = new URL(`${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/safes/${address}/collectibles/`);
        const excludeSpam = ((_a = options === null || options === void 0 ? void 0 : options.excludeSpamTokens) === null || _a === void 0 ? void 0 : _a.toString()) || 'true';
        url.searchParams.set('exclude_spam', excludeSpam);
        return (0, httpRequests_1.sendRequest)({ url: url.toString(), method: httpRequests_1.HttpMethod.Get });
    }
    ...
    async getToken(tokenAddress) {
        ...
        const { address } = await __classPrivateFieldGet(this, _SafeServiceClient_ethAdapter, "f").getEip3770Address(tokenAddress);
        return (0, httpRequests_1.sendRequest)({
            url: `${__classPrivateFieldGet(this, _SafeServiceClient_txServiceBaseUrl, "f")}/tokens/${address}/`,
            method: httpRequests_1.HttpMethod.Get
        });
    }
}
_SafeServiceClient_txServiceBaseUrl = new WeakMap(), _SafeServiceClient_ethAdapter = new WeakMap();
